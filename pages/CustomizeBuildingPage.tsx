...
//   // FIX: Updated initial state to conform to the BuildingData type from types.ts.
//   const [buildingData, setBuildingData] = useState<BuildingData>({
//     locationRegion: 'Central',
//     housingType: 'Luxury Apartment',
//     floors: '1-5',
//     roomsMin: 1,
//     roomsMax: 6,
//     elevators: 1,
...
//   // FIX: Updated form change handler to work with the new BuildingData structure.
//   const handleFormChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
//     const { name, value } = e.target;
//     if (name === 'roomsMin' || name === 'roomsMax' || name === 'elevators') {
